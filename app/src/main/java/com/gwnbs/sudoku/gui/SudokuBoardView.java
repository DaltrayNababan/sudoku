...
public class SudokuBoardView extends View {
    ...
    private final Paint mCellValuePaint;
    private final Paint mCellValueReadonlyPaint;
    private final Paint mCellNotePaint;
    private int mNumberLeft;
    private int mNumberTop;
    private float mNoteTop;
    private int mSectorLineWidth;
    private final Paint mBackgroundColorSecondary;
    private final Paint mBackgroundColorReadOnly;
    private final Paint mBackgroundColorTouched;
    private final Paint mBackgroundColorSelected;
    private final Paint mBackgroundColorHighlighted;
    private final Paint mCellValueInvalidPaint;
    ...
    public void setTypeface(Typeface typeface) {
        mCellValuePaint.setTypeface(typeface);
    }
            ...
            for (int row = 0; row < 9; row++) {
                for (int col = 0; col < 9; col++) {
                    ...
                    switch (mHighlightSimilarCells) {
                        ...
                        case NUMBERS: {
                            shouldHighlightCell = cellIsNotAlreadySelected && highlightedValueIsValid &&
                    ...
                    if (shouldHighlightCell) {
                        if (mBackgroundColorHighlighted.getColor() != NO_COLOR) {
                            canvas.drawRect(cellLeft, cellTop, cellLeft + mCellWidth,
                                    cellTop + mCellHeight, mBackgroundColorHighlighted);
                        }
                    }
                }
            }
