...
import com.gwnbs.sudoku.gui.inputmethod.IMControlPanelStatePersister.StateBundle;
...
public class IMNumpad extends InputMethod {
    ...
    public IMNumpad(Context context) {
        this.mContext = context;
    }

    private Map<Integer, Button> mNumberButtons;
    private final OnClickListener mNumberButtonClick = new OnClickListener() {
        @Override
    ...
    protected View createControlPanelView() {
        ...
        @SuppressLint("InflateParams") View controlPanel = inflater.inflate(R.layout.im_numpad, null);
