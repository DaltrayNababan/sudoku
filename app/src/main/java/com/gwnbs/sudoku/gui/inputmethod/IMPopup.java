...
import com.gwnbs.sudoku.gui.inputmethod.IMPopupDialog.OnNoteEditListener;
import com.gwnbs.sudoku.gui.inputmethod.IMPopupDialog.OnNumberEditListener;
...
public class IMPopup extends InputMethod {
     ...
     */
    private final OnNumberEditListener mOnNumberEditListener = new OnNumberEditListener() {
        @Override
        public void onNumberEdit(int number) {
     ...
     */
    private final OnNoteEditListener mOnNoteEditListener = new OnNoteEditListener() {
        @Override
        public void onNoteEdit(Integer[] numbers) {
     ...
     */
    private final OnDismissListener mOnPopupDismissedListener = dialog -> mBoard.hideTouchedCellHint();
