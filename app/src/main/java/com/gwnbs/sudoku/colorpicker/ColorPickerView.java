package com.gwnbs.sudoku.colorpicker;
...
public class ColorPickerView extends View {
    ...
    private void drawHuePanel(Canvas canvas) {
        ...
        if (mHueShader == null) {
            mHueShader = new LinearGradient(rect.left, rect.top, rect.left, rect.bottom, buildHueColorArray(), null, Shader.TileMode.CLAMP);
